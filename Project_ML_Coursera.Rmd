---
title: "Coursera Practical Machine Learning Project Week 4"
Name : "Prediction Assignment Writeup"
...
setwd("D:/Users/bbalacha/Documents/ProjectML")
library(knitr)
library(caret)
library(rpart)
library(rpart.plot)
...
dim(TestSet)
```
```{r remove variables that are mostly NA}
...
```
```{r Confusion matrix and Prediction }
# prediction on Test dataset
